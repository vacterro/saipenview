...
- **Залепване в ъгли** - `Ctrl+Q` превключва TL → TR → BL → BR
...
| **Залепване в ъгъл** | `Ctrl+Q` - превключва Горе-Ляво → Горе-Дясно → Долу-Ляво → Долу-Дясно |
...
├── zone_picker.py      Оверлей за залепване в ъгъл Ctrl+Q (tkinter)
