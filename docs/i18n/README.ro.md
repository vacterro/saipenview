...
<p align="center">
  <img src="../../screenshots/dashboard.png" alt="Captură de ecran Tablou de Bord SAIPENVIEW" width="85%" style="border-radius: 4px; border: 1px solid #3a3020;">
  <br>
  <em>Fiecare proiect SAIPEN, sub-agent, tichet și status git — toate într-o singură vizualizare.</em>
</p>
