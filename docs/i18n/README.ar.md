...
- **التصاق الزوايا** - `Ctrl+Q` يتنقل TL ← TR ← BL ← BR
...
| **التصاق الزاوية** | `Ctrl+Q` - يتنقل أعلى-يسار ← أعلى-يمين ← أسفل-يسار ← أسفل-يمين |
...
├── zone_picker.py      تراكب التصاق الزاوية Ctrl+Q (tkinter)
